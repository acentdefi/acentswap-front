        ...
        return (
          <CardBody>
            <Heading as="h4" color="secondary" mb="16px">
              Get ACENT-BNB LP Tokens
            </Heading>
            <Text color="textSubtle" small>
              Stake ACENT and BNB in the liquidity pool to get LP tokens. <br />
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent ACENT-BNB LP
