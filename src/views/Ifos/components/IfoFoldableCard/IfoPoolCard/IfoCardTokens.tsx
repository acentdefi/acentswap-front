...
import { Text, Flex, Box, Image, CheckmarkCircleIcon, FlexProps, HelpIcon, useTooltip } from 'acentswap-uikit-hwan'
...
const IfoCardTokens: React.FC<IfoCardTokensProps> = ({
  ...
  const renderTokenSection = () => {
    ...
    if (account && !hasProfile) {
      return <Text textAlign="center">{t('You need an active AcentSwap Profile to take part in an IFO!')}</Text>
    }
    ...
    if (publicIfoData.status === 'live') {
      return (
        <>
          <TokenSection img="/images/farms/acent-bnb.png" mb="24px">
