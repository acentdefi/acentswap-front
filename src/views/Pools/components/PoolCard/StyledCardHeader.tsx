...
import { CardHeader, Heading, Text, Flex, Image } from 'acentswap-uikit-hwan'
...
const StyledCardHeader: React.FC<{
  ...
  const isCakePool = earningTokenSymbol === 'ACENT' && stakingTokenSymbol === 'ACENT'
  ...
  const getSubHeading = () => {
    ...
    if (isCakePool) {
      return `${t('Earn ACENT, stake ACENT')}`
    }
