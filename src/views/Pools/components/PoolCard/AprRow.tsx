...
import { Flex, TooltipText, IconButton, useModal, CalculateIcon, Skeleton, useTooltip } from 'acentswap-uikit-hwan'
...
const AprRow: React.FC<AprRowProps> = ({
  ...
  const tooltipContent = isAutoVault
    ? t('APY includes compounding, APR doesn’t. This pool’s ACENT is compounded automatically, so we show APY.')
