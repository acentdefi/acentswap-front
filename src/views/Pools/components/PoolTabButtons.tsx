...
import { ButtonMenu, ButtonMenuItem, Toggle, Text, Flex, NotificationDot } from 'acentswap-uikit-hwan'
  ...
  return (
    <Flex alignItems="center" justifyContent="center" mb="32px">
      ...
      {/* <Flex ml="24px" alignItems="center" justifyContent="flex-end">
        <StyledLink external href="https://docs.acentswap.com/cake-pools/cake-pool">
