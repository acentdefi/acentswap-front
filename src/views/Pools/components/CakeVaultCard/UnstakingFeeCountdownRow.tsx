...
import { Flex, Text, TooltipText, useTooltip } from 'acentswap-uikit-hwan'
...
const UnstakingFeeCountdownRow: React.FC<UnstakingFeeCountdownRowProps> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      ...
      <Text>
        {t(
          'Only applies within 3 days of staking. Unstaking after 3 days will not include a fee. Timer resets every time you stake new ACENT in the pool.',
        )}
      </Text>
    </>,
