...
import { Modal, Text, Flex, Image, Button, Slider, BalanceInput, AutoRenewIcon } from 'acentswap-uikit-hwan'
...
const VaultStakeModal: React.FC<VaultStakeModalProps> = ({
  ...
  const handleWithdrawal = async (convertedStakeAmount: BigNumber) => {
    ...
    // trigger withdrawAll function if the withdrawal will leave 0.000000000000200000 ACENT or less
