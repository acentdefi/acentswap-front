...
const Mint: React.FC = () => {
  ...
  return (
    <>
      ...
      <Text as="p">{t('This starter will also acentme your first profile picture.')}</Text>
      <Text as="p" mb="24px">
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" mb="24px" color="textSubtle">
            {t(`Cost: ${MINT_COST} ACENT`, { num: MINT_COST })}
          </Text>
          {nfts.map((nft) => {
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mb="16px">
              {t('A minimum of %num% ACENT is required', { num: MINT_COST })}
            </Text>
          )}
