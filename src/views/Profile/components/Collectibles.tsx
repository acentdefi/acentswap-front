...
import { Heading, Text, Flex, ChevronRightIcon } from 'acentswap-uikit-hwan'
...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the AcentSwap platform.')}
      </Text>
      <Text as="p">
