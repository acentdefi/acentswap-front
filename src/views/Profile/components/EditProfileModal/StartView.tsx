...
import { Button, Flex, Text, InjectedModalProps } from 'acentswap-uikit-hwan'
...
const StartPage: React.FC<StartPageProps> = ({ goToApprove, goToChange, goToRemove, onDismiss }) => {
  ...
  /**
   * Check if the wallet has the required ACENT allowance to change their profile pic or reactivate
      ...
      <Flex alignItems="center" style={{ height: '48px' }} justifyContent="center">
        <Text as="p" color="failure">
          {!hasMinimumCakeRequired &&
            t(`${getFullDisplayBalance(minimumCakeRequired)} ACENT required to change profile pic`)}
        </Text>
      </Flex>
      {profile.isActive ? (
        <>
