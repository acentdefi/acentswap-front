...
import { Text, Flex, Box, ErrorIcon, Button } from 'acentswap-uikit-hwan'
    ...
    >
      <Box ml="48px">
        <Text color="warning" bold>
          You must complete migration if you want to keep earning from any AcentSwap LP tokens and AcentSwap farms.
        </Text>
